...
class CipeRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function getAllegatiByIdCipe($id) {
        $parameters = array ();
        $filter = "";
        $filter .= " AND p.idCipe = :id ";
        $parameters['id'] = $id;
        ...
        $query = $qb
            ...
            ->leftJoin('UserBundle:RelAllegatiCipe', 'p', 'WITH', 'a.id = p.idAllegati')
            ->where('1=1' . $filter)
            ->setParameters($parameters);
