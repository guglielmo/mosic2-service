...
//    }
    ...
    if (isset($_REQUEST['step6'])) {
        ...
        $return = getDelibereCCFix(); if(isset($return)) { $fineStep6 = $return; goto jump;}

        $fineStep6 ="<strong>PROCEDURA CONCLUSA</strong>";
    }


//    if (isset($_REQUEST['step7'])) {
//        require_once "delete-table.php";
//        //header("Location: " . $_SERVER['PHP_SELF']);
//        $fineStep7 ="Tabelle originali eliminate con successo.<br><strong>PROCEDURA CONCLUSA</strong>";
//    }
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <form action="" method="post">
                ...
                <button type="submit" name="step6" class="btn btn-primary btn-block"><strong>STEP 6</strong> - Sposta file delibere in delibere CC</button>
                <button type="submit" name="step7" class="btn btn-primary btn-block"><strong>STEP 7</strong> - Elimina tabelle orginali</button>
            </form>
        </div>
